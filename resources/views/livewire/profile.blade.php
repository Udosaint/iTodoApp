              ...
              <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                <div
                  ...
                  <div class="relative drop-shadow-2 ">
                    <img src="{{auth()->user()->photo? asset('storage/'.auth()->user()->photo) : asset('img/avatar-ali.png')}}" alt="profile" class="rounded-full ring-2 ring-brightRed" />
                ...
                <div class="mt-4">
                  ...
                  <div
                    ...
                    <div
                      ...
                      <span class="font-semibold text-black dark:text-white">{{auth()->user()->firstname}}</span>
                    </div>
                    ...
                    <div
                      ...
                      <span class="font-semibold text-black dark:text-white">{{auth()->user()->lastname}}</span>
                    </div>
                    ...
                    <div
                      ...
                      <div class="ring-r border-3 border-stroke">:</div>
                      <span class="font-semibold text-black dark:text-white">{{auth()->user()->email}}</span>
                    </div>
                    ...
                    <div
                      ...
                      <div class="ring-r border-3 border-stroke">:</div>
                      <span class="font-semibold text-black dark:text-white">{{auth()->user()->profession}}</span>
                    </div>
                    ...
                    <div
                      ...
                      <div class="ring-r border-3 border-stroke">:</div>
                      <span class="font-semibold text-black dark:text-white">{{auth()->user()->phone}}</span>
                    </div> 
