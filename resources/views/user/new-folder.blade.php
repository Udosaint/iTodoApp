                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-4 gap-4 md:grid-cols-5 md:gap-4 xl:grid-cols-6 2xl:gap-7 ">
                            ...
                            <div class="border border-stroke p-3 bg-white shadow-3 rounded">
                                ...
                                <span class="ml-2"><i class=" fas fa-folder text-yellow-500 "></i></span>
                                </label>
                            </div>
                            <div class="border border-stroke p-3 bg-white shadow-3 rounded">
                                <label class="flex items-center">
                                <input type="radio" class="form-radio focus:border-2 " name="radio-option" value="option2">
                                <span class="ml-2"><i class=" fas fa-fire text-blue-600"></i></span>
                            </div>
                            <div class="border border-stroke p-3 bg-white shadow-3 rounded">
                                <label class="flex items-center">
                                <input type="radio" class="form-radio focus:border-2 " name="radio-option" value="option2">
                                <span class="ml-2"><i class=" fas fa-circle text-green-500"></i></span>
                            </div>
                            <div class="border border-stroke p-3 bg-white shadow-3 rounded">
                                <label class="flex items-center">
                                <input type="radio" class="form-radio focus:border-2 " name="radio-option" value="option2">
                                <span class="ml-2"><i class=" fas fa-file-contract text-darkBlue"></i></span>
                            </div>
