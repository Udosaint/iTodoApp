...
>
  ...
  <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
    ...
    <a href="{{route('user.dashboard')}}">
      <img src="img/itodo-logo.png" alt="Logo"  class="w-52 items-center justify-center"/>
    </a>
  ...
  >
    ...
    <div
      ...
      <img src="img/avatar-ali.png" class="w-18  rounded-full ring-2 ring-brightRed" alt="">
      <p class="mb-1 mt-3 text-md font-medium text-darkBlue">Okoye Udochukwu</p>
      <p class="mb-4 text-xs text-darkBlue">udosaint@gmail.com</p>
    </div>
    <!-- Promo Box -->
  </div>
</aside>
