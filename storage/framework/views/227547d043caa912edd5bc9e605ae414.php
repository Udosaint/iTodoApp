...
<?php $component->withAttributes([]); ?>
      ...
      <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('settings', ['user' => auth()->user()])->html();
    ...
    $response = \Livewire\Livewire::mount('settings', ['user' => auth()->user()]);
    $html = $response->html();
...
<?php /**PATH C:\MY FILES\LARAVEL\PROJECT\iTodoApp\resources\views/user/setting.blade.php ENDPATH**/ ?>