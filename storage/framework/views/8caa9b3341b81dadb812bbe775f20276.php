            ...
            <?php if(session()->has('message')): ?>
                <div id="alerts" x-show=alert x-data={alert:true} x-init="setTimeout(() => alert = false, 3000)" 
                    @click="alert= !alert"  class="absolute items-center translate-x-0 cursor-pointer  duration-300 ease-linear  right-6 flex w-70 md:w-96 mt-10.5 border-l-6 border-[#1d1e1e]
        ...
        <?php /**PATH C:\MY FILES\LARAVEL\PROJECT\iTodoApp\resources\views/components/alert.blade.php ENDPATH**/ ?>