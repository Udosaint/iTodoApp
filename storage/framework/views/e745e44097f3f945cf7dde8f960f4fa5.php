...
<?php endif; ?>
        ...
        <div class="hidden md:flex md:w-1/2 h-screen bg-gradient-to-tr from-brightRedLight from-40% to-darkGrayishBlue bg-gray-300  items-center justify-center">
            <img src="<?php echo e(asset('img/login-1.png')); ?>" alt="Image" class="w-3/4">
        </div>
        ...
        <div class=" flex flex-col h-screen w-full md:w-3/5  md:h-screen md:flex items-center justify-center p-2">
            ...
            <div class=" p-8 rounded-xl shadow-sm shadow-veryDarkBlue w-full md:w-3/5  bg-white">
                <h2 class="text-3xl font-bold mb-6 mt-6 text-center text-veryDarkBlue">Sign in to <?php echo e(env('SITE')); ?></h2>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <a href="<?php echo e(route('forget.password')); ?>" class=" text-brightRed font-bold nav-link">Forget Password</a>
                    ...
                    <p class="mb-8 mt-8 text-center text-veryDarkBlue font-bold nav-link">
                        New to <?php echo e(env('SITE')); ?>? 
                        <a href="<?php echo e(route('register')); ?>" class=" text-brightRed font-bold nav-link">Create Account</a>
                    </p>
...
<?php /**PATH C:\MY FILES\LARAVEL\PROJECT\iTodoApp\resources\views/livewire/auth/login.blade.php ENDPATH**/ ?>