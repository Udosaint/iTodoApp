    ...
    <section id="testimonials">
      ...
      <div class="max-w-6xl px-5 mx-auto mb-6 mt-32 text-center">
        <!-- Heading -->
        <h2 class="text-4xl font-bold text-center text-veryDarkBlue">
          What's Different About <?php echo e(env('SITE')); ?>?
        </h2>
    ...
    </section><?php /**PATH C:\MY FILES\LARAVEL\PROJECT\iTodoApp\resources\views/components/testimony.blade.php ENDPATH**/ ?>