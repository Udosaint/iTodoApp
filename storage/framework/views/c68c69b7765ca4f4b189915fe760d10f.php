...
<header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
  <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
    ...
    <div class="flex items-center gap-2 sm:gap-4 ">
      ...
      <!-- Hamburger Toggle BTN -->
      <a class="block flex-shrink-0 lg:hidden" href="<?php echo e(route('user.dashboard')); ?>">
      ...
      <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
        <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
          <span class="hidden text-right lg:block">
            <span class="block text-sm font-medium text-black dark:text-white"><?php echo e(auth()->user()->firstname); ?> <?php echo e(auth()->user()->lastname); ?></span>
            <span class="block text-xs font-medium"><?php echo e(auth()->user()->profession); ?></span>
          </span>

          <span class="h-12 w-12 rounded-full">
            <img src="<?php echo e(auth()->user()->photo? asset('storage/'.auth()->user()->photo) : asset('img/avatar-ali.png')); ?>" alt="User" />
          </span>
...
<?php /**PATH C:\MY FILES\LARAVEL\PROJECT\iTodoApp\resources\views/components/app-header.blade.php ENDPATH**/ ?>